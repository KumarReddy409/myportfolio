    ...
    return (
        ...
        <Row className="d-flex justify-content-around">
          ...
          <Col md={4}>
            ...
            <Card className="focus mt-2 mb-2 ">
              <Card.Body>
                <Card.Title className="text-center  card-title">CI/CD</Card.Title>
                <hr />
                <Card.Text className="card-text d-flex justify-content-start flex-column">
                <span className="p-2">
                    <a className="text-dark text-decoration-none" href={skillsdata.CI[0].link} target="_blank" rel="noopener noreferrer">
                      <Image src={skillsdata.CI[0].imgSrc} alt={skillsdata.CI[0].imgAltText} rounded className="image-style m-1"></Image> {skillsdata.CI[0].skillName}
                    </a>
                  </span>
                </Card.Text>
              </Card.Body>
